...
Download the latest `.dmg` from [Releases](https://github.com/user/synclock/releases) and drag **Synclock.app** to Applications.
...
```bash
git clone https://github.com/user/synclock.git
cd synclock
npm install
npm run tauri build
```
